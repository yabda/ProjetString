...
INSERT INTO Project(id,title,description,goal,current,deadLine,createdAt,failed,belonguser_id,category_id,updatedAt) VALUES (10,'Parrainez un Panda','Nous accueillons notamment un groupe de panda geant, espèce classée en danger critique d’extinction',10000,500,'2018-12-13','2018-10-13',0,13,1,null);
INSERT INTO Project(id,title,description,goal,current,deadLine,createdAt,failed,belonguser_id,category_id,updatedAt) VALUES (11,'Album de jean-Michel Jarre','Aider à financer le nouveau album de Jean-Michel Jarre intitulé "Crissements imfames"',50000,2200,'2018-12-25','2018-10-25',0,12,2,null);
INSERT INTO Project(id,title,description,goal,current,deadLine,createdAt,failed,belonguser_id,category_id,updatedAt) VALUES (12,'Une montre connectée révolutionnaire','Montre GPS possédant un écran Géant 4K de 25" de diagonnal, le futur est a porter de main ',25000,100,'2018-12-13','2018-10-13',0,10,3,null);
...
INSERT INTO COUNTERPART(id,description,name,price,belongproject_id) VALUES (13,'Un disque en avant première','Disque',25,11);
INSERT INTO COUNTERPART(id,description,name,price,belongproject_id) VALUES (14,'Un disque dédicacé dès sa sortie','Dedicace',100,11);
INSERT INTO COUNTERPART(id,description,name,price,belongproject_id) VALUES (15,'Un concert privé pour votre marriage','concert',1500,11);
...
INSERT INTO COUNTERPART(id,description,name,price,belongproject_id) VALUES (17,'Je deviens votre ami le plus sincère' ,'Amitié',200,13);
...
INSERT INTO MESSAGE(id,content,belongproject_id,belonguser_id) VALUES (100,'Je te soutiens, je suis impatiente de pouvoir jouer à Smash Bros',13,11);
